...
import {
    GridSubwayStationName,
    useSubwayStationNameGridModelStore,
    useSubwayStationNameStore
} from "../../../../stores/subway.ts"
import {
    createSubwayStationName,
    deleteSubwayStationName,
...
export function SubwayStationNameGrid(props: GridProps) {
    ...
    const deleteRowButtonClicked = async (id: GridRowId) => {
        ...
        const response = await deleteSubwayStationName(rowToDelete.name)
    ...
    const updateRowProcess = async (newRow: GridSubwayStationName) => {
        if (newRow.name === "") {
        ...
        const response = await createSubwayStationName({
            name: newRow.name,
        })
